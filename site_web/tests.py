...
# class Extraction(TestCase):
    ...
    # @patch("site_web.management.commands.extraction.requests.get")
    # @patch("site_web.management.commands.extraction.STDOUT", new_callable=bool)
    # def test_extraction(self, mock, mock_json):
        # mock = False
